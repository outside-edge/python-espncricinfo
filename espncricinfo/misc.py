...
class Batsman:
    def __init__(self, data):
        self.balls_faced = int(data.get("balls_faced", 0))
        self.hand = data.get("hand", "")
        self.image_path = data.get("image_path", "")
        self.name = data.get("known_as", "")
        self.notout = int(data.get("notout", 0))
...
class Bowler:
    def __init__(self, data):
        self.conceded = int(data.get("conceded", 0))
        self.hand = data.get("hand", "")
        self.image_path = data.get("image_path", "")
        self.name = data.get("known_as", "")
        self.maidens = int(data.get("maidens", 0))
        self.overs = float(data.get("overs") or 0.0)
        self.pacespin = data.get("pacespin", "")
        self.player_id = int(data.get("player_id") or 0)
        self.popular_name = data.get("popular_name", "")
        self.position = int(data.get("position", 0))
        self.wickets = int(data.get("wickets", 0))
...
class Inning:
    def __init__(self, data):
        self.ball_limit = int(data.get("ball_limit", 0))
        self.balls = int(data.get("balls", 0))
        self.batted = int(data.get("batted", 0))
        self.batting_team_id = int(data.get("batting_team_id") or 0)
        self.bowling_team_id = int(data.get("bowling_team_id") or 0)
        self.bpo = int(data.get("bpo", 6))  # Balls per over
        self.byes = int(data.get("byes", 0))
        self.event = int(data.get("event", 0))
        self.event_name = data.get("event_name", "")
        self.extras = int(data.get("extras", 0))
        self.number = int(data.get("innings_number", 0))
        self.numth = data.get("innings_numth", "")
        self.lead = int(data.get("lead", 0))
        self.legbyes = int(data.get("legbyes", 0))
        self.live_current = int(data.get("live_current", 0))
        self.live_current_name = data.get("live_current_name", "")
        self.minutes = data.get("minutes")
        self.noballs = int(data.get("noballs", 0))
        self.old_penalty_or_bonus = int(data.get("old_penalty_or_bonus", 0))
        ...
        self.overs = float(data.get("overs") or 0.0)
        self.overs_docked = int(data.get("overs_docked", 0))
        self.penalties = int(data.get("penalties", 0))
        self.penalties_field_end = int(data.get("penalties_field_end", 0))
        self.penalties_field_start = int(data.get("penalties_field_start", 0))
        self.run_rate = float(data.get("run_rate") or 0.0)
        self.runs = int(data.get("runs", 0))
        self.target = int(data.get("target", 0))
        self.wickets = int(data.get("wickets", 0))
        self.wides = int(data.get("wides", 0))
...
class Player:
    def __init__(self, player_data):
        self.age_days = int(player_data.get("age_days", 0))
        self.age_years = int(player_data.get("age_years", 0))
        ...
        self.captain = int(player_data.get("captain", 0))
        ...
        self.keeper = int(player_data.get("keeper", 0))
        ...
        self.p_type = int(player_data.get("player_type", 0))
...
class Team:
    def __init__(self, team_data):
        self.batsmen_in_side = int(team_data.get("batsmen_in_side", 0))
        self.content_id = int(team_data.get("content_id") or 0)
        self.country_id = int(team_data.get("country_id") or 0)
        self.fielders_in_side = int(team_data.get("fielders_in_side", 0))
        ...
        self.logo_height = int(team_data.get("logo_height", 0))
        self.logo_image_height = int(team_data.get("logo_image_height", 0))
        self.logo_image_path = team_data.get("logo_image_path")
        self.logo_image_width = int(team_data.get("logo_image_width", 0))
        self.logo_object_id = int(team_data.get("logo_object_id") or 0)
        self.logo_path = team_data.get("logo_path")
        self.logo_width = int(team_data.get("logo_width", 0))
        self.object_id = int(team_data.get("object_id") or 0)
        self.players = [Player(p) for p in team_data.get("player", [])]
        self.players_in_side = int(team_data.get("players_in_side", 0))
...
class Live:
    def __init__(self, json_data):
        ...
        self.ball_limit = int(json_data['live']['innings']['ball_limit'])
        self.balls = int(json_data['live']['innings']['balls'])
        self.current_inning = int(json_data['live']['innings']['innings_number'])
        self.batting_team_id = int(json_data['live']['innings']['batting_team_id'])
        self.bowling_team_id = int(json_data['live']['innings']['bowling_team_id'])
        self.overs = float(json_data['live']['innings'].get('overs') or 0.0)
        self.remaining_balls = int(json_data['live']['innings']['remaining_balls'])
        self.rrr = float(json_data['live']['innings'].get('required_run_rate') or 0.0)
        self.crr = float(json_data['live']['innings'].get('run_rate') or 0.0)
        self.runs = int(json_data['live']['innings']['runs'])
        self.target = int(json_data['live']['innings']['target'])
        self.team_id = int(json_data['live']['innings']['team_id'])
        self.wickets = int(json_data['live']['innings']['wickets'])